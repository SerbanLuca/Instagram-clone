        ...
        <div className='post'>
            ...
            <div>
                {comments.map((comment) =>(
                    <p>
                        <strong>{comment.username}</strong>{comment.text} {comment.timestamp}
                    </p>
                ))}
            </div>

            <form>
                 <input type='text' placeholder='add a comment here' value={comment} onChange={(e) => setComment(e.target.value)} />
